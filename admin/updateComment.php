...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $service = $pdo->prepare("SELECT * FROM comments WHERE id = :id");
...
<div class="container">
    ...
    <form action="/admin/realising/updateComment.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <input type="hidden" name="id" value="<?php echo $res_serv->id; ?>">
            <input type="text" class="form-control" placeholder="Enter title" name="text" value="<?php echo $res_serv->text; ?>" required>
        </div>
